/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2575cf26b672401b241e5dbb2f568a5e)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		SKILLFORGE_PROVIDER: "deepseek";
		SKILLFORGE_MOCK_MODE: "true";
		ADMIN_EMAILS: "hungkescy@gmail.com,admin@skillforge.local";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SKILLFORGE_PROVIDER" | "SKILLFORGE_MOCK_MODE" | "ADMIN_EMAILS" | "CLOUDFLARE_API_TOKEN" | "ANTHROPIC_API_KEY" | "DEEPSEEK_API_KEY">> {}
}
